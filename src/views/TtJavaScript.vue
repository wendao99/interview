  ...
  data () {
    return {
      javaScriptList: [
        {
          id: 1,
          title: "1. 介绍 js 的基本数据类型。",
          answer: `js 一共有六种基本数据类型，分别是 Undefined、Null、Boolean、Number、String，还有在 ES6 中新增的 Symbol 和 ES10 中新增的 BigInt 类型。
...
`,
        ...
        {
          id: 2,
          title: "2. JavaScript 有几种类型的值？你能画一下他们的内存图吗？",
          answer: `js 可以分为两种类型的值，一种是基本数据类型，一种是复杂数据类型。
...
`,
        ...
        {
          id: 3,
          title: "3. 什么是堆？什么是栈？它们之间有什么区别和联系？",
          answer: `堆和栈的概念存在于数据结构中和操作系统内存中。
...
`,
        ...
        {
          id: 4,
          title: "4. 内部属性 [[Class]] 是什么？",
          answer: `所有 typeof 返回值为 "object" 的对象（如数组）都包含一个内部属性 [[Class]]（我们可以把它看作一个内部的分类，而非
...
`,
        },
        {
          ...
          answer: `js 中的内置对象主要指的是在程序执行前存在全局作用域里的由 js 定义的一些全局值属性、函数和用来实例化其他对象的构造函
...
`,
        },
        {
          ...
          answer: `已在作用域中声明但还没有赋值的变量，是 undefined 的。相反，还没有在作用域中声明过的变量，是 undeclared 的。
...
`,
        },
        {
          ...
          answer: `首先 Undefined 和 Null 都是基本数据类型，这两个基本数据类型分别都只有一个值，就是 undefined 和 null。
...
`,
        },
        {
          ...
          answer: `因为 undefined 是一个标识符，所以可以被当作变量来使用和赋值，但是这样会影响 undefined 的正常判断。
...
`,
        ...
        {
          id: 9,
          title: "9. 说几条写 JavaScript 的基本规范？",
          answer: `在平常项目开发中，我们遵守一些这样的基本规范，比如说：
...
`,
        ...
        {
          id: 10,
          title: "10. JavaScript 原型，原型链？ 有什么特点？",
          answer: `在 js 中我们是使用构造函数来新建一个对象的，每一个构造函数的内部都有一个 prototype 属性值，这个属性值是一个对
...
Object.getPrototypeOf(p)`,
        ...
        {
          id: 12,
          title: "12. 在 js 中不同进制数字的表示方式",
          answer: `以 0X、0x 开头的表示为十六进制。
...
以 0B、0b 开头的表示为二进制格式。`,
        ...
        {
          id: 13,
          title: "13. js 中整数的安全范围是多少？",
          answer: `安全整数指的是，在这个范围内的整数转化为二进制存储的时候不会出现精度丢失，能够被“安全”呈现的最大整数是 2^53 - 1，
...
`,
        ...
        {
          id: 14,
          title: "14. typeof NaN 的结果是什么？",
          answer: `NaN 意指“不是一个数字”（not a number），NaN 是一个“警戒值”（sentinel value，有特殊用途的常规值），用于指出
...
`,
        ...
        {
          id: 15,
          title: "15. isNaN 和 Number.isNaN 函数的区别？",
          answer: `函数 isNaN 接收参数后，会尝试将这个参数转换为数值，任何不能被转换为数值的的值都会返回 true，因此非数字值传入也会
返回 true ，会影响 NaN 的判断。
...
`,
        ...
        {
          id: 16,
          title: "16. Array 构造函数只有一个参数值时的表现？",
          answer: `Array 构造函数只带一个数字参数的时候，该参数会被作为数组的预设长度（length），而非只充当数组中的一个元素。这样
...
`,
        ...
        {
          id: 17,
          title: "17. 其他值到字符串的转换规则？",
          answer: `规范的 9.8 节中定义了抽象操作 ToString ，它负责处理非字符串到字符串的强制类型转换。
...
`,
        },
        {
          ...
          answer: `有时我们需要将非数字值当作数字来使用，比如数学运算。为此 ES5 规范在 9.3 节定义了抽象操作 ToNumber。
...
`,
        ...
        {
          id: 19,
          title: "19. 其他值到布尔类型的值的转换规则？",
          answer: `ES5 规范 9.2 节中定义了抽象操作 ToBoolean，列举了布尔强制类型转换所有可能出现的结果。
...
`,
        ...
        {
          id: 20,
          title: "20. {} 和 [] 的 valueOf 和 toString 的结果是什么？",
          answer: `{} 的 valueOf 结果为 {} ，toString 的结果为 "[object Object]"
...
`,
        },
        {
          id: 21,
          title: "21. 什么是假值对象？",
          answer: `浏览器在某些特定情况下，在常规 JavaScript 语法基础上自己创建了一些外来值，这些就是“假值对象”。假值对象看起来和
...
`,
        },
        {
          id: 22,
          title: "22. ~ 操作符的作用？",
          answer: `~ 返回 2 的补码，并且 ~ 会将数字转换为 32 位整数，因此我们可以使用 ~ 来进行取整操作。
...
`,
        ...
        {
          id: 23,
          title: "23. 解析字符串中的数字和将字符串强制类型转换为数字的返回结果都是数字，它们之间的区别是什么？",
          answer: `解析允许字符串（如 parseInt() ）中含有非数字字符，解析按从左到右的顺序，如果遇到非数字字符就停止。而转换（如 Nu
...
`,
        },
        {
          ...
          answer: `根据 ES5 规范 11.6.1 节，如果某个操作数是字符串或者能够通过以下步骤转换为字符串的话，+ 将进行拼接操作。如果其
...
`,
        ...
        {
          id: 25,
          title: "25. 什么情况下会发生布尔值的隐式强制类型转换？",
          answer: `（1） if (..) 语句中的条件判断表达式。
...
`,
        },
        {
          id: 26,
          title: "26. || 和 && 操作符的返回值？",
          answer: `|| 和 && 首先会对第一个操作数执行条件判断，如果其不是布尔值就先进行 ToBoolean 强制类型转换，然后再执行条件
判断。
...
`,
        ...
        {
          id: 27,
          title: "27. Symbol 值的强制类型转换？",
          answer: `ES6 允许从符号到字符串的显式强制类型转换，然而隐式强制类型转换会产生错误。
...
`,
        ...
        {
          id: 28,
          title: "28. == 操作符的强制类型转换规则？",
          answer: `（1）字符串和数字之间的相等比较，将字符串转换为数字之后再进行比较。
...
`,
        ...
        {
          id: 29,
          title: "29. 如何将字符串转化为数字，例如 '12.3b'?",
          answer: `（1）使用 Number() 方法，前提是所包含的字符串不包含不合法字符。
...
`,
        ...
        {
          id: 30,
          title: "30. 如何将浮点数点左边的数每三位添加一个逗号，如 12000000.11 转化为『12,000,000.11』?",
          answer: `// 方法一
...
`,
        },
        {
          id: 32,
          title: "32. 生成随机数的各种方法？",
          answer: `https://www.hangge.com/blog/cache/detail_1872.html`,
        },
        {
          id: 33,
          title: "33. 如何实现数组的随机排序？",
          answer: `// （1）使用数组 sort 方法对数组元素随机排序，让 Math.random() 出来的数与 0.5 比较，如果大于就返回 1 交换位置，如果小于就返回 -1，不交换位置。
...
`,
        ...
        {
          id: 34,
          title: "34. javascript 创建对象的几种方式？",
          answer: `我们一般使用字面量的形式直接创建对象，但是这种创建方式对于创建大量相似对象的时候，会产生大量的重复代码。但 js
...
`,
        ...
        {
          id: 35,
          title: "35. JavaScript 继承的几种实现方式？",
          answer: `我了解的 js 中实现继承的几种方式有：
...
`,
        ...
        {
          id: 37,
          title: "37. Javascript 的作用域链？",
          answer: `作用域链的作用是保证对执行环境有权访问的所有变量和函数的有序访问，通过作用域链，我们可以访问到外层环境的变量和
函数。
...
`,
        },
        {
          ...
          answer: `this 是执行上下文中的一个属性，它指向最后一次调用这个方法的对象。在实际开发中，this 的指向可以通过四种调用模
式来判断。
...
是函数调用模式。`,
        },
        {
          id: 39,
          title: "39. eval 是做什么的？",
          answer: `它的功能是把对应的字符串解析成 JS 代码并运行。
...
`,
        },
        {
          ...
          answer: `DOM 指的是文档对象模型，它指的是把文档当做一个对象来对待，这个对象主要定义了处理网页内容的方法和接口。
...
`,
        ...
        {
          id: 42,
          title: "42. 事件是什么？IE 与火狐的事件机制有什么区别？ 如何阻止冒泡？",
          answer: `1.事件是用户操作网页时发生的交互动作，比如 click/move， 事件除了用户触发的动作外，还可以是文档加载，窗口滚动和大小调整。事件被封装成一个 event 对象，包含了该事件发生时的所有相关信息（ event 的属性）以及可以对事件进行的操作（ event 的方法）。
...
3.event.stopPropagation() 或者 ie 下的方法 event.cancelBubble = true;`,
        },
        {
          id: 43,
          title: "43. 三种事件模型是什么？",
          answer: `事件是用户操作网页时发生的交互动作或者网页本身的一些操作，现代浏览器一共有三种事件模型。
...
`,
        },
        {
          id: 44,
          title: "44. 事件委托是什么？",
          answer: `事件委托本质上是利用了浏览器事件冒泡的机制。因为事件在冒泡过程中会上传到父节点，并且父节点可以通过事件对象获取到
...
`,
        ...
        {
          id: 45,
          title: "45. ['1', '2', '3'].map(parseInt) 答案是多少？",
          answer: `parseInt() 函数能解析一个字符串，并返回一个整数，需要两个参数 (val, radix)，其中 radix 表示要解析的数字的基数。（该值介于 2 ~ 36 之间，并且字符串中的数字不能大于 radix 才能正确返回数字结果值）。
...
`,
        ...
        {
          id: 46,
          title: "46. 什么是闭包，为什么要用它？",
          answer: `闭包是指有权访问另一个函数作用域中变量的函数，创建闭包的最常见的方式就是在一个函数内创建另一个函数，创建的函数可以
访问到当前函数的局部变量。
...
`,
        ...
        {
          id: 47,
          title: "47. javascript 代码中的 'use strict'; 是什么意思 ? 使用它区别是什么？",
          answer: `use strict 指的是严格运行模式，在这种模式对 js 的使用添加了一些限制。比如说禁止 this 指向全局对象，还有禁止使
...
`,
        ...
        {
          id: 48,
          title: "48. 如何判断一个对象是否属于某个类？",
          answer: `第一种方式是使用 instanceof 运算符来判断构造函数的 prototype 属性是否出现在对象的原型链中的任何位置。
...
`,
        ...
        {
          id: 49,
          title: "49. instanceof 的作用？",
          answer: `// instanceof 运算符用于判断构造函数的 prototype 属性是否出现在对象的原型链中的任何位置。
// 实现：
...
`,
        ...
        {
          id: 50,
          title: "50. new 操作符具体干了什么呢？如何实现？",
          answer: `// （1）首先创建了一个新的空对象
...
`,
        ...
        {
          id: 51,
          title: "51. Javascript 中，有一个函数，执行时对象查找时，永远不会去查找原型，这个函数是？",
...
`,
        ...
        {
          id: 52,
          title: "52. 对于 JSON 的了解？",
          answer: `JSON 是一种基于文本的轻量级的数据交换格式。它可以被任何的编程语言读取和作为数据格式来传递。
...
`,
        ...
        {
          id: 53,
          title: '53. [].forEach.call($$("*"),function(a){a.style.outline="1px solid #"+(~~(Math.random()*(1<<24))).toString(16)}) 能解释一下这段代码的意思吗？',
          answer: `（1）选取页面所有 DOM 元素。在浏览器的控制台中可以使用$$()方法来获取页面中相应的元素，这是现代浏览器提供的一个命令行 API 相当于 document.querySelectorAll 方法。
...
`,
        ...
        {
          id: 54,
          title: "54. js 延迟加载的方式有哪些？",
          answer: `js 的加载、解析和执行会阻塞页面的渲染过程，因此我们希望 js 脚本能够尽可能的延迟加载，提高页面的渲染速度。
...
`,
        ...
        {
          id: 55,
          title: "55. Ajax 是什么? 如何创建一个 Ajax？",
          answer: `我对 ajax 的理解是，它是一种异步通信的方法，通过直接由 js 脚本向服务器发起 http 通信，然后根据服务器返回的数据，更新网页的相应部分，而不用刷新整个页面的一种方法。
...
`,
        ...
        {
          id: 56,
          title: "56. 谈一谈浏览器的缓存机制？",
          answer: `浏览器的缓存机制指的是通过在一段时间内保留已接收到的 web 资源的一个副本，如果在资源的有效时间内，发起了对这个资源的再一次请求，那么浏览器会直接使用缓存的副本，而不是向服务器发起请求。使用 web 缓存可以有效地提高页面的打开速度，减少不必要的网络带宽的消耗。
...
`,
        ...
        {
          id: 57,
          title: "57. Ajax 解决浏览器缓存问题？",
          answer: `1.在 ajax 发送请求前加上 anyAjaxObj.setRequestHeader("If-Modified-Since","0")。
...
5.如果是使用 jQuery，直接这样就可以了$.ajaxSetup({cache:false})。这样页面的所有 ajax 都会执行这条语句就是不需要保存缓存记录。`,
        },
        {
          id: 58,
          title: "58. 同步和异步的区别？",
          answer: `同步指的是当一个进程在执行某个请求的时候，如果这个请求需要等待一段时间才能返回，那么这个进程会一直等待下去，直到消息返
回为止再继续向下执行。
...
`,
        ...
        {
          id: 59,
          title: "59. 什么是浏览器的同源政策？",
          answer: `我对浏览器的同源政策的理解是，一个域下的 js 脚本在未经允许的情况下，不能够访问另一个域的内容。这里的同源的指的是两个
...
`,
        },
        {
          id: 60,
          title: "60. 如何解决跨域问题？",
          answer: `解决跨域的方法我们可以根据我们想要实现的目的来划分。
...
`,
        ...
        {
          id: 61,
          title: "61. 服务器代理转发时，该如何处理 cookie？",
          answer: `详细资料可以参考： 《深入浅出 Nginx》`,
        },
        {
          id: 62,
          title: "62. 简单谈一下 cookie ？",
          answer: `我的理解是 cookie 是服务器提供的一种用于维护会话状态信息的数据，通过服务器发送到浏览器，浏览器保存在本地，当下一次有同源的请求时，将保存的 cookie 值添加到请求头部，发送给服务端。这可以用来实现记录用户登录状态等功能。cookie 一般可以存储 4k 大小的数据，并且只能够被同源的网页所共享访问。
...
`,
        },
        {
          id: 63,
          title: "63. 模块化开发怎么做？",
          answer: `我对模块的理解是，一个模块是实现一个特定功能的一组方法。在最开始的时候，js 只实现一些简单的功能，所以并没有模块的概念
...
`,
        ...
        {
          id: 65,
          title: "65. AMD 和 CMD 规范的区别？",
          answer: `它们之间的主要区别有两个方面。
...
（2）第二个方面是对依赖模块的执行时机处理不同。首先 AMD 和 CMD 对于模块的加载方式都是异步加载，不过它们的区别在于 模块的执行时机，AMD 在依赖模块加载完成后就直接执行依赖模块，依赖模块的执行顺序和我们书写的顺序不一定一致。而 CMD 在依赖模块加载完成后并不执行，只是下载而已，等到所有的依赖模块都加载好后，进入回调函数逻辑，遇到 require 语句 的时候才执行对应的模块，这样模块的执行顺序就和我们书写的顺序保持一致了。`,
        ...
        {
          id: 66,
          title: "66. ES6 模块与 CommonJS 模块、AMD、CMD 的差异。",
          answer: `1.CommonJS 模块输出的是一个值的拷贝，ES6 模块输出的是值的引用。CommonJS 模块输出的是值的拷贝，也就是说，一旦输出一个值，模块内部的变化就影响不到这个值。ES6 模块的运行机制与 CommonJS 不一样。JS 引擎对脚本静态分析的时候，遇到模块加载命令 import，就会生成一个只读引用。等到脚本真正执行时，再根据这个只读引用，到被加载的那个模块里面去取值。

2.CommonJS 模块是运行时加载，ES6 模块是编译时输出接口。CommonJS 模块就是对象，即在输入时是先加载整个模块，生成一个对象，然后再从这个对象上面读取方法，这种加载称为“运行时加载”。而 ES6 模块不是对象，它的对外接口只是一种静态定义，在代码静态解析阶段就会生成。`,
        },
        {
          id: 67,
          title: "67. requireJS 的核心原理是什么？（如何动态加载的？如何避免多次加载的？如何 缓存的？）",
          answer: `require.js 的核心原理是通过动态创建 script 脚本来异步引入模块，然后对每个脚本的 load 事件进行监听，如果每个脚本都加载完成了，再调用回调函数。
`,
        },
        {
          id: 68,
          title: "68. JS 模块加载器的轮子怎么造，也就是如何实现一个模块加载器？",
          answer: `详细资料可以参考： 《JS 模块加载器加载原理是怎么样的？》`,
        },
        {
          id: 69,
          title: "69. ECMAScript6 怎么写 class，为什么会出现 class 这种东西?",
          answer: `在我看来 ES6 新添加的 class 只是为了补充 js 中缺少的一些面向对象语言的特性，但本质上来说它只是一种语法糖，不是一个新的东西，其背后还是原型继承的思想。通过加入 class 可以有利于我们更好的组织代码。

在 class 中添加的方法，其实是添加在类的原型上的。`,
        },
        {
          id: 70,
          title: "70. documen.write 和 innerHTML 的区别？",
          answer: `document.write 的内容会代替整个文档内容，会重写整个页面。
...
`,
        ...
        {
          id: 71,
          title: "71. DOM 操作——怎样添加、移除、移动、复制、创建和查找节点？",
          answer: `（1）创建新节点
...
removeAttribute(key);`,
        ...
        {
          id: 72,
          title: "72. innerHTML 与 outerHTML 的区别？",
          answer: `对于这样一个 HTML 元素：<div>content<br/></div>。
...
`,
        ...
        {
          id: 73,
          title: "73. .call() 和 .apply() 的区别？",
          answer: `它们的作用一模一样，区别仅在于传入参数的形式的不同。
...
`,
        ...
        {
          id: 74,
          title: "74. JavaScript 类数组对象的定义？",
          answer: `一个拥有 length 属性和若干索引属性的对象就可以被称为类数组对象，类数组对象和数组类似，但是不能调用数组的方法。
...
Array.from(arrayLike);`,
        ...
        {
          id: 75,
          title: "75. 数组和对象有哪些原生方法，列举一下？",
          answer: `数组和字符串的转换方法：toString()、toLocalString()、join() 其中 join() 方法可以指定转换为字符串时的分隔符。
...
`,
        ...
        {
          id: 76,
          title: "76. 数组的 fill 方法？",
          answer: `fill() 方法用一个固定值填充一个数组中从起始索引到终止索引内的全部元素。不包括终止索引。
...
`,
        },
        {
          id: 77,
          title: "77. [,,,] 的长度？",
          answer: `尾后逗号 （有时叫做“终止逗号”）在向 JavaScript 代码添加元素、参数、属性时十分有用。如果你想要添加新的属性，并且上一行已经使用了尾后逗号，你可以仅仅添加新的一行，而不需要修改上一行。这使得版本控制更加清晰，以及代码维护麻烦更少。
...
`,
        ...
        {
          id: 78,
          title: "78. JavaScript 中的作用域与变量声明提升？",
          answer: `变量提升的表现是，无论我们在函数中何处位置声明的变量，好像都被提升到了函数的首部，我们可以在变量声明前访问到而不会报错。
...
`,
        ...
        {
          id: 79,
          title: "79. 如何编写高性能的 Javascript ？",
          answer: `1.使用位运算代替一些简单的四则运算。
2.避免使用过深的嵌套循环。
3.不要使用未定义的变量。
4.当需要多次访问数组长度时，可以用变量保存起来，避免每次都会去进行属性查找。`,
        ...
        {
          id: 80,
          title: "80. 简单介绍一下 V8 引擎的垃圾回收机制",
          answer: `v8 的垃圾回收机制基于分代回收机制，这个机制又基于世代假说，这个假说有两个特点，一是新生的对象容易早死，另一个是不死的对象会活得更久。基于这个假说，v8 引擎将内存分为了新生代和老生代。
...
`,
        ...
        {
          id: 81,
          title: "81. 哪些操作会造成内存泄漏？",
          answer: `第一种情况是我们由于使用未声明的变量，而意外的创建了一个全局变量，而使这个变量一直留在内存中无法被回收。
...
`,
        ...
        {
          id: 82,
          title: "82. 需求：实现一个页面操作不会整页刷新的网站，并且能在浏览器前进、后退时正确响应。给出你的技术实现方案？",
          answer: `通过使用 pushState + ajax 实现浏览器无刷新前进后退，当一次 ajax 调用成功后我们将一条 state 记录加入到 history
...
`,
        ...
        {
          id: 83,
          title: "83. 如何判断当前脚本运行在浏览器还是 node 环境中？（阿里）",
          answer: `typeof window === 'undefined' ? 'node' : 'browser';
...
`,
        ...
        {
          id: 84,
          title: "84. 把 script 标签放在页面的最底部的 body 封闭之前和封闭之后有什么区别？浏览器会如何解析它们？",
          answer: `详细资料可以参考： 《为什么把 script 标签放在 body 结束标签之后 html 结束标签之前？》 《从 Chrome 源码看浏览器如何加载资源》`,
        },
        {
          id: 85,
          title: "85. 移动端的点击事件的有延迟，时间是多久，为什么会有？ 怎么解决这个延时？",
          answer: `移动端点击有 300ms 的延迟是因为移动端会有双击缩放的这个操作，因此浏览器在 click 之后要等待 300ms，看用户有没有下一次点击，来判断这次操作是不是双击。
有三种办法来解决这个问题：
...
`,
        ...
        {
          id: 87,
          title: "87. 如何测试前端代码么？ 知道 BDD, TDD, Unit Test 么？ 知道怎么测试你的前端工程么(mocha, sinon, jasmin, qUnit..)？",
          answer: `详细资料可以参考： 《浅谈前端单元测试》`,
        },
        {
          id: 88,
          title: "88. 检测浏览器版本版本有哪些方式？",
          answer: `检测浏览器版本一共有两种方式：
...
`,
        ...
        {
          id: 89,
          title: "89. 什么是 Polyfill ？",
          answer: `Polyfill 指的是用于实现浏览器并不支持的原生 API 的代码。
...
`,
        ...
        {
          id: 90,
          title: "90. 使用 JS 实现获取文件扩展名？",
          answer: `// String.lastIndexOf() 方法返回指定值（本例中的'.'）在调用该方法的字符串中最后出现的位置，如果没找到则返回 -1。
...
`,
        ...
        {
          id: 91,
          title: "91. 介绍一下 js 的节流与防抖？",
          answer: `函数防抖是指在事件被触发 n 秒后再执行回调，如果在这 n 秒内事件又被触发，则重新计时。这可以使用在一些点击请求的事件上，避免因为用户的多次点击向后端发送多次请求。
...
`,
        ...
        {
          id: 92,
          title: "92. Object.is() 与原来的比较操作符 “===”、“==” 的区别？",
          answer: `使用双等号进行相等判断时，如果两边的类型不一致，则会进行强制类型转化后再进行比较。
...
`,
        ...
        {
          id: 93,
          title: "93. escape,encodeURI,encodeURIComponent 有什么区别？",
          answer: `encodeURI 是对整个 URI 进行转义，将 URI 中的非法字符转换为合法字符，所以对于一些在 URI 中有特殊意义的字符不会进行转义。
...
`,
        ...
        {
          id: 94,
          title: "94. Unicode 和 UTF-8 之间的关系？",
          answer: `Unicode 是一种字符集合，现在可容纳 100 多万个字符。每个字符对应一个不同的 Unicode 编码，它只规定了符号的二进制代码，却没有规定这个二进制代码在计算机中如何编码传输。
...
`,
        ...
        {
          id: 95,
          title: "95. js 的事件循环是什么？",
          answer: `因为 js 是单线程运行的，在代码执行的时候，通过将不同函数的执行上下文压入执行栈中来保证代码的有序执行。在执行同步代码的时候，如果遇到了异步事件，js 引擎并不会一直等待其返回结果，而是会将这个事件挂起，继续执行执行栈中的其他任务。当异步事件执行完毕后，再将异步事件对应的回调加入到与当前执行栈中不同的另一个任务队列中等待执行。任务队列可以分为宏任务对列和微任务对列，当当前执行栈中的事件执行完毕后，js 引擎首先会判断微任务对列中是否有任务可以执行，如果有就将微任务队首的事件压入栈中执行。当微任务对列中的任务都执行完成后再去判断宏任务对列中的任务。
...
`,
        ...
        {
          id: 96,
          title: "96. js 中的深浅拷贝实现？",
          answer: `浅拷贝指的是将一个对象的属性值复制到另一个对象，如果有的属性的值为引用类型的话，那么会将这个引用的地址复制给对象，因此两个对象会有同一个引用类型的引用。浅拷贝可以使用  Object.assign 和展开运算符来实现。
...
`,
        ...
        {
          id: 97,
          title: "97. 手写 call、apply 及 bind 函数",
          answer: `call 函数的实现步骤：
...
4.函数内部使用 apply 来绑定函数调用，需要判断函数作为构造函数的情况，这个时候需要传入当前函数的 this 给 apply 调用，其余情况都传入指定的上下文对象。`,
        },
        {
          id: 98,
          title: "98. 函数柯里化的实现",
          answer: `// 函数柯里化指的是一种将使用多个参数的一个函数转换成一系列使用一个参数的函数的技术。
...
`,
        ...
        {
          id: 99,
          title: "99. 为什么 0.1 + 0.2 != 0.3？如何解决这个问题？",
          answer: `当计算机计算 0.1+0.2 的时候，实际上计算的是这两个数字在计算机里所存储的二进制，0.1 和 0.2 在转换为二进制表示的时候会出现位数无限循环的情况。js 中是以 64 位双精度格式来存储数字的，只有 53 位的有效数字，超过这个长度的位数会被截取掉这样就造成了精度丢失的问题。这是第一个会造成精度丢失的地方。在对两个以 64 位双精度格式的数据进行计算的时候，首先会进行对阶的处理，对阶指的是将阶码对齐，也就是将小数点的位置对齐后，再进行计算，一般是小阶向大阶对齐，因此小阶的数在对齐的过程中，有效数字会向右移动，移动后超过有效位数的位会被截取掉，这是第二个可能会出现精度丢失的地方。当两个数据阶码对齐后，进行相加运算后，得到的结果可能会超过 53 位有效数字，因此超过的位数也会被截取掉，这是可能发生精度丢失的第三个地方。
...
`,
        ...
        {
          id: 100,
          title: "100. 原码、反码和补码的介绍",
          answer: `原码是计算机中对数字的二进制的定点表示方法，最高位表示符号位，其余位表示数值位。优点是易于分辨，缺点是不能够直接参与运算。
...
`,
        ...
        {
          id: 101,
          title: "101. toPrecision 和 toFixed 和 Math.round 的区别？",
          answer: `toPrecision 用于处理精度，精度是从左至右第一个不为 0 的数开始数起。
...
`,
        ...
        {
          id: 102,
          title: "102. 什么是 XSS 攻击？如何防范 XSS 攻击？",
          answer: `XSS 攻击指的是跨站脚本攻击，是一种代码注入攻击。攻击者通过在网站注入恶意脚本，使之在用户的浏览器上运行，从而盗取用户的信息如 cookie 等。
...
`,
        },
        {
          id: 103,
          title: "103. 什么是 CSP？",
          answer: `CSP 指的是内容安全策略，它的本质是建立一个白名单，告诉浏览器哪些外部资源可以加载和执行。我们只需要配置规则，如何拦截由浏览器自己来实现。
...
`,
        ...
        {
          id: 104,
          title: "104. 什么是 CSRF 攻击？如何防范 CSRF 攻击？",
          answer: `CSRF 攻击指的是跨站请求伪造攻击，攻击者诱导用户进入一个第三方网站，然后该网站向被攻击网站发送跨站请求。如果用户在被
...
`,
        ...
        {
          id: 105,
          title: "105. 什么是 Samesite Cookie 属性？",
          answer: `Samesite Cookie 表示同站 cookie，避免 cookie 被第三方所利用。
...
`,
        ...
        {
          id: 106,
          title: "106. 什么是点击劫持？如何防范点击劫持？",
          answer: `点击劫持是一种视觉欺骗的攻击手段，攻击者将需要攻击的网站通过 iframe 嵌套的方式嵌入自己的网页中，并将 iframe 设置为透明，在页面中透出一个按钮诱导用户点击。
...
`,
        },
        {
          id: 107,
          title: "107. SQL 注入攻击？",
          answer: `SQL 注入攻击指的是攻击者在 HTTP 请求中注入恶意的 SQL 代码，服务器使用参数构建数据库 SQL 命令时，恶意 SQL 被一起构
造，破坏原有 SQL 结构，并在数据库中执行，达到编写程序时意料之外结果的攻击行为。
`,
        },
        {
          id: 108,
          title: "108. 什么是 MVVM？比之 MVC 有什么区别？什么又是 MVP ？",
          answer: `MVC、MVP 和 MVVM 是三种常见的软件架构设计模式，主要通过分离关注点的方式来组织代码结构，优化我们的开发效率。
...
`,
        ...
        {
          id: 109,
          title: "109. vue 双向数据绑定原理？",
          answer: `vue 通过使用双向数据绑定，来实现了 View 和 Model 的同步更新。vue 的双向数据绑定主要是通过使用数据劫持和发布订阅者模式来实现的。
...
`,
        ...
        {
          id: 110,
          title: "110. Object.defineProperty 介绍？",
          answer: `Object.defineProperty 函数一共有三个参数，第一个参数是需要定义属性的对象，第二个参数是需要定义的属性，第三个是该属性描述符。
...
`,
        ...
        {
          id: 111,
          title: "111. 使用 Object.defineProperty() 来进行数据劫持有什么缺点？",
          answer: `有一些对属性的操作，使用这种方法无法拦截，比如说通过下标方式修改数组数据或者给对象新增属性，vue 内部通过重写函数解决了这个问题。在 Vue3.0 中已经不使用这种方式了，而是通过使用 Proxy 对对象进行代理，从而实现数据劫持。使用 Proxy 的好处是它可以完美的监听到任何方式的数据改变，唯一的缺点是兼容性的问题，因为这是 ES6 的语法。
`,
        },
        {
          id: 112,
          title: "112. 什么是 Virtual DOM？为什么 Virtual DOM 比原生 DOM 快？",
          answer: `我对 Virtual DOM 的理解是，
...
`,
        ...
        {
          id: 113,
          title: "113. 如何比较两个 DOM 树的差异？",
          answer: `两个树的完全 diff 算法的时间复杂度为 O(n^3) ，但是在前端中，我们很少会跨层级的移动元素，所以我们只需要比较同一层级的元素进行比较，这样就可以将算法的时间复杂度降低为 O(n)。
...
`,
        ...
        {
          id: 114,
          title: "114. 什么是 requestAnimationFrame ？",
          answer: `详细资料可以参考： 《你需要知道的 requestAnimationFrame》 《CSS3 动画那么强，requestAnimationFrame 还有毛线用？》`,
        },
        {
          id: 115,
          title: "115. 谈谈你对 webpack 的看法",
          answer: `我当时使用 webpack 的一个最主要原因是为了简化页面依赖的管理，并且通过将其打包为一个文件来降低页面加载时请求的资源
数。
...
`,
        ...
        {
          id: 116,
          title: "116. offsetWidth/offsetHeight,clientWidth/clientHeight 与 scrollWidth/scrollHeight 的区别？",
          answer: `clientWidth/clientHeight 返回的是元素的内部宽度，它的值只包含 content + padding，如果有滚动条，不包含滚动条。
...
`,
        ...
        {
          id: 117,
          title: "117. 谈一谈你理解的函数式编程？",
          answer: `简单说，"函数式编程"是一种"编程范式"（programming paradigm），也就是如何编写程序的方法论。
...
`,
        ...
        {
          id: 119,
          title: "119. Js 动画与 CSS 动画区别及相应实现",
          answer: `CSS3 的动画的优点
...
`,
        ...
        {
          id: 120,
          title: "120. get 请求传参长度的误区",
          answer: `误区：我们经常说 get 请求参数的大小存在限制，而 post 请求的参数大小是无限制的。
...
4.要支持 IE，则最大长度为 2083byte，若只支持 Chrome，则最大长度 8182byte`,
        ...
        {
          id: 121,
          title: "121. URL 和 URI 的区别？",
          answer: `URI: Uniform Resource Identifier      指的是统一资源标识符
...
`,
        ...
        {
          id: 122,
          title: "122. get 和 post 请求在缓存方面的区别",
          answer: `缓存一般只适用于那些不会更新服务端数据的请求。一般 get 请求都是查找请求，不会对服务器资源数据造成修改，而 post 请求一般都会对服务器数据造成修改，所以，一般会对 get 请求进行缓存，很少会对 post 请求进行缓存。
`,
        },
        {
          id: 123,
          title: "123. 图片的懒加载和预加载",
          answer: `懒加载也叫延迟加载，指的是在长网页中延迟加载图片的时机，当用户需要访问时，再去加载，这样可以提高网站的首屏加载速度，提升用户的体验，并且可以减少服务器的压力。它适用于图片很多，页面很长的电商网站的场景。懒加载的实现原理是，将页面上的图片的 src 属性设置为空字符串，将图片的真实路径保存在一个自定义属性中，当页面滚动的时候，进行判断，如果图片进入页面可视区域内，则从自定义属性中取出真实路径赋值给图片的 src 属性，以此来实现图片的延迟加载。
...
`,
        ...
        {
          id: 124,
          title: "124. mouseover 和 mouseenter 的区别？",
          answer: `当鼠标移动到元素上时就会触发 mouseenter 事件，类似 mouseover，它们两者之间的差别是 mouseenter 不会冒泡。
...
`,
        ...
        {
          id: 125,
          title: "125. js 拖拽功能的实现",
          answer: `一个元素的拖拽过程，我们可以分为三个步骤，第一步是鼠标按下目标元素，第二步是鼠标保持按下的状态移动鼠标，第三步是鼠
标抬起，拖拽过程结束。
...
`,
        ...
        {
          id: 126,
          title: "126. 为什么使用 setTimeout 实现 setInterval？怎么模拟？",
...
`,
        ...
        {
          id: 127,
          title: "127. let 和 const 的注意点？",
          answer: `1.声明的变量只在声明时的代码块内有效
2.不存在声明提升
...
4.不允许重复声明，重复声明会报错`,
        },
        {
          ...
          answer: `rest 参数（形式为...变量名），用于获取函数的多余参数。
`,
        },
        {
          id: 129,
          title: "129. 什么是尾调用，使用尾调用有什么好处？",
          answer: `尾调用指的是函数的最后一步调用另一个函数。我们代码执行是基于执行栈的，所以当我们在一个函数里调用另一个函数时，我们会保留当前的执行上下文，然后再新建另外一个执行上下文加入栈中。使用尾调用的话，因为已经是函数的最后一步，所以这个时候我们可以不必再保留当前的执行上下文，从而节省了内存，这就是尾调用优化。但是 ES6 的尾调用优化只在严格模式下开启，正常模式是无效的。
`,
        },
        {
          id: 130,
          title: "130. Symbol 类型的注意点？",
          answer: `1.Symbol 函数前不能使用 new 命令，否则会报错。
...
6.Symbol.keyFor 方法返回一个已登记的 Symbol 类型值的 key。`,
        ...
        {
          id: 131,
          title: "131. Set 和 WeakSet 结构？",
          answer: `1.ES6 提供了新的数据结构 Set。它类似于数组，但是成员的值都是唯一的，没有重复的值。
2.WeakSet 结构与 Set 类似，也是不重复的值的集合。但是 WeakSet 的成员只能是对象，而不能是其他类型的值。WeakSet 中的对象都是弱引用，即垃圾回收机制不考虑 WeakSet 对该对象的引用，`,
        },
        {
          id: 132,
          title: "132. Map 和 WeakMap 结构？",
          answer: `1.Map 数据结构。它类似于对象，也是键值对的集合，但是“键”的范围不限于字符串，各种类型的值（包括对象）都可以当作键。
2.WeakMap 结构与 Map 结构类似，也是用于生成键值对的集合。但是 WeakMap 只接受对象作为键名（ null 除外），不接受其他类型的值作为键名。而且 WeakMap 的键名所指向的对象，不计入垃圾回收机制。`,
        },
        {
          id: 133,
          title: "133. 什么是 Proxy ？",
          answer: `Proxy 用于修改某些操作的默认行为，等同于在语言层面做出修改，所以属于一种“元编程”，即对编程语言进行编程。
...
`,
        ...
        {
          id: 134,
          title: "134. Reflect 对象创建目的？",
          answer: `1.将 Object 对象的一些明显属于语言内部的方法（比如 Object.defineProperty，放到 Reflect 对象上。
...
4.Reflect 对象的方法与 Proxy 对象的方法一一对应，只要是 Proxy 对象的方法，就能在 Reflect 对象上找到对应的方法。这就让 Proxy 对象可以方便地调用对应的 Reflect 方法，完成默认行为，作为修改行为的基础。也就是说，不管 Proxy 怎么修改默认行为，你总可以在 Reflect 上获取默认行为。`,
        ...
        {
          id: 135,
          title: "135. require 模块引入的查找方式？",
          answer: `当 Node 遇到 require(X) 时，按下面的顺序处理。
...
`,
        ...
        {
          id: 136,
          title: "136. 什么是 Promise 对象，什么是 Promises/A+ 规范？",
          answer: `Promise 对象是异步编程的一种解决方案，最早由社区提出。Promises/A+ 规范是 JavaScript Promise 的标准，规定了一个 Promise 所必须具有的特性。
...
`,
        ...
        {
          id: 137,
          title: "137. 手写一个 Promise",
          answer: `const PENDING = "pending";
...
`,
        ...
        {
          id: 138,
          title: "138. 如何检测浏览器所支持的最小字体大小？",
          answer: `用 JS 设置 DOM 的字体为某一个值，然后再取出来，如果值设置成功，就说明支持。
`,
        },
        {
          id: 139,
          title: "139. 怎么做 JS 代码 Error 统计？",
          answer: `error 统计使用浏览器的 window.error 事件。
`,
        },
        {
          id: 140,
          title: "140. 单例模式模式是什么？",
          answer: `单例模式保证了全局只有一个实例来被访问。比如说常用的如弹框组件的实现和全局状态的实现。
`,
        },
        {
          id: 141,
          title: "141. 策略模式是什么？",
          answer: `策略模式主要是用来将方法的实现和方法的调用分离开，外部通过不同的参数可以调用不同的策略。我主要在 MVP 模式解耦的时候
用来将视图层的方法定义和方法调用分离。
`,
        },
        {
          id: 142,
          title: "142. 代理模式是什么？",
          answer: ` 代理模式是为一个对象提供一个代用品或占位符，以便控制对它的访问。比如说常见的事件代理。
`,
        },
        {
          id: 143,
          title: "143. 中介者模式是什么？",
          answer: `中介者模式指的是，多个对象通过一个中介者进行交流，而不是直接进行交流，这样能够将通信的各个对象解耦。
`,
        },
        {
          id: 144,
          title: "144. 适配器模式是什么？",
          answer: `适配器用来解决两个接口不兼容的情况，不需要改变已有的接口，通过包装一层的方式实现两个接口的正常协作。假如我们需要一种
...
`,
        ...
        {
          id: 145,
          title: "145. 观察者模式和发布订阅模式有什么不同？",
          answer: `发布订阅模式其实属于广义上的观察者模式
...
`,
        ...
        {
          id: 146,
          title: "146. Vue 的生命周期是什么？",
          answer: `Vue 的生命周期指的是组件从创建到销毁的一系列的过程，被称为 Vue 的生命周期。通过提供的 Vue 在生命周期各个阶段的钩子函数，我们可以很好的在 Vue 的各个生命阶段实现一些操作。
`,
        },
        {
          id: 147,
          title: "147. Vue 的各个生命阶段是什么？",
          answer: `Vue 一共有8个生命阶段，分别是创建前、创建后、加载前、加载后、更新前、更新后、销毁前和销毁后，每个阶段对应了一个生命周期的钩子函数。
...
`,
        ...
        {
          id: 149,
          title: "149. computed 和 watch 的差异？",
          answer: `（1）computed 是计算一个新的属性，并将该属性挂载到 Vue 实例上，而 watch 是监听已经存在且已挂载到 Vue 实例上的数据，所以用 watch 同样可以监听 computed 计算属性的变化。
...
`,
        ...
        {
          id: 150,
          title: "150. vue-router 中的导航钩子函数",
          answer: `（1）全局的钩子函数 beforeEach 和 afterEach
...
`,
        ...
        {
          id: 151,
          title: "151. $route 和 $router 的区别？",
          answer: `$route 是“路由信息对象”，包括 path，params，hash，query，fullPath，matched，name 等路由信息参数。而 $router 是“路由实例”对象包括了路由的跳转方法，钩子函数等。
`,
        },
        {
          id: 152,
          title: "152. vue 常用的修饰符？",
          answer: `.prevent: 提交事件不再重载页面；.stop: 阻止单击事件冒泡；.self: 当事件发生在该元素本身而不是子元素的时候会触发；
`,
        },
        {
          id: 153,
          title: "153. vue 中 key 值的作用？",
          answer: `vue 中 key 值的作用可以分为两种情况来考虑。
...
`,
        ...
        {
          id: 154,
          title: "154. computed 和 watch 区别？",
          answer: `computed 是计算属性，依赖其他属性计算值，并且 computed 的值有缓存，只有当计算值变化才会返回内容。
...
`,
        ...
        {
          id: 155,
          title: "155. keep-alive 组件有什么作用？",
          answer: `如果你需要在组件切换的时候，保存一些组件的状态防止多次渲染，就可以使用 keep-alive 组件包裹需要保存的组件。
`,
        },
        {
          id: 156,
          title: "156. vue 中 mixin 和 mixins 区别？",
          answer: `mixin 用于全局混入，会影响到每个组件实例。
...
`,
        ...
        {
          id: 157,
          title: "157. 开发中常用的几种 Content-Type ？",
          answer: `（1）application/x-www-form-urlencoded
...
`,
        ...
        {
          id: 158,
          title: "158. 如何封装一个 javascript 的类型判断函数？",
...
`,
        ...
        {
          id: 159,
          title: "159. 如何判断一个对象是否为空对象？",
          answer: `function checkNullObj(obj) {
...
`,
        ...
        {
          id: 160,
          title: "160. 使用闭包实现每隔一秒打印 1,2,3,4",
          answer: `// 使用闭包实现
for (var i = 0; i < 5; i++) {
  (function(i) {
    setTimeout(function() {
...
`,
        ...
        {
          id: 161,
          title: "161. 手写一个 jsonp",
          answer: `function jsonp(url, params, callback) {
  // 判断是否含有参数
...
`,
        ...
        {
          id: 165,
          title: "165. 如何确定页面的可用性时间，什么是 Performance API？",
          answer: `Performance API 用于精确度量、控制、增强浏览器的性能表现。这个 API 为测量网站性能，提供以前没有办法做到的精度。
...
var pageLoadTime = t.loadEventEnd - t.navigationStart;`,
        },
        {
          id: 166,
          title: "166. js 中的命名规则",
          answer: `（1）第一个字符必须是字母、下划线（_）或美元符号（$）
...
`,
        ...
        {
          id: 167,
          title: "167. js 语句末尾分号是否可以省略？",
          answer: `在 ECMAScript 规范中，语句结尾的分号并不是必需的。但是我们一般最好不要省略分号，因为加上分号一方面有
...
`,
        },
        {
          ...
          answer: `Object.assign() 方法用于将所有可枚举属性的值从一个或多个源对象复制到目标对象。它将返回目标对象。
`,
        },
        {
          id: 169,
          title: "169. Math.ceil 和 Math.floor",
          answer: `Math.ceil() === 向上取整，函数返回一个大于或等于给定数字的最小整数。
...
`,
        ...
        {
          id: 170,
          title: "170. js for 循环注意点",
          answer: `for (var i = 0, j = 0; i < 5, j < 9; i++, j++) {
  console.log(i, j);
}
...
`,
        ...
        {
          id: 171,
          title: "171. 一个列表，假设有 100000 个数据，这个该怎么办？",
          answer: `我们需要思考的问题：该处理是否必须同步完成？数据是否必须按顺序完成？
...
`,
        ...
        {
          id: 172,
          title: "172. js 中倒计时的纠偏实现？",
          answer: `在前端实现中我们一般通过 setTimeout 和 setInterval 方法来实现一个倒计时效果。但是使用这些方法会存在时间偏差的问题，这是由于 js 的程序执行机制造成的，setTimeout 和 setInterval 的作用是隔一段时间将回调事件加入到事件队列中，因此事件并不是立即执行的，它会等到当前执行栈为空的时候再取出事件执行，因此事件等待执行的时间就是造成误差的原因。
...
6.套接字通信`,
        ...
        {
          id: 174,
          title: "174. 如何查找一篇英文文章中出现频率最高的单词？",
          answer: `function findMostWord(article) {
  // 合法性判断
  if (!article) return;
