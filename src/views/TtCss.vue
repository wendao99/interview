  ...
  data() {
    return {
      cssList: [
        {
          id: 1,
          title: "1.介绍一下标准的 CSS 的盒子模型？低版本 IE 的盒子模型有什么不同的？",
          answer: `盒模型都是由四个部分组成的，分别是margin、border、padding和content。
...
`,
        ...
        {
          id: 3,
          title: "3.::before 和:after 中双冒号和单冒号有什么区别？解释一下这 2 个伪元素的作用。",
          answer: `在css3中使用单冒号来表示伪类，用双冒号来表示伪元素。但是为了兼容已有的伪元素的写法，在一些浏览器中也可以使用单冒号
来表示伪元素。
...
`,
        },
        {
          id: 4,
          title: "4.伪类与伪元素的区别",
          answer: `css引入伪类和伪元素概念是为了格式化文档树以外的信息。也就是说，伪类和伪元素是用来修饰不在文档树中的部分，比如，一句
...
`,
        ...
        {
          id: 5,
          title: "5.CSS 中哪些属性可以继承？",
          answer: `每一个属性在定义中都给出了这个属性是否具有继承性，一个具有继承性的属性会在没有指定值的时候，会使用父元素的同属性的值
来作为自己的值。
...
`,
        ...
        {
          id: 6,
          title: "6.CSS 优先级算法如何计算？",
          answer: `判断优先级时，首先我们会判断一条属性声明是否有权重，也就是是否在声明后面加上了!important。一条声明如果加上了权重，
...
`,
        ...
        {
          id: 7,
          title: "7.关于伪类 LVHA 的解释?",
          answer: `a标签有四种状态：链接访问前、链接访问后、鼠标滑过、激活，分别对应四种伪类:link、:visited、:hover、:active；
...
`,
        ...
        {
          id: 8,
          title: "8.CSS3 新增伪类有那些？",
          answer: `（1）elem:nth-child(n)选中父元素下的第n个子元素，并且这个子元素的标签名为elem，n可以接受具体的数
值，也可以接受函数。
...
`,
        ...
        {
          id: 10,
          title: "10.display 有哪些值？说明他们的作用。",
          answer: `block	块类型。默认宽度为父元素宽度，可设置宽高，换行显示。
none	元素不显示，并从文档流中移除。
...
`,
        ...
        {
          id: 11,
          title: "11.position 的值 relative 和 absolute 定位原点是？",
          answer: `relative定位的元素，是相对于元素本身的正常位置来进行定位的。
...
`,
        ...
        {
          id: 12,
          title: "12.CSS3 有哪些新特性？（根据项目回答）",
          answer: `新增各种CSS选择器	（:not(.input)：所有class不是“input”的节点）
...
`,
        ...
        {
          id: 13,
          title: "13.请解释一下 CSS3 的 Flex box（弹性盒布局模型），以及适用场景？",
          answer: `flex布局是CSS3新增的一种布局方式，我们可以通过将一个元素的display属性值设置为flex从而使它成为一个flex
容器，它的所有子元素都会成为它的项目。
...
`,
        ...
        {
          id: 14,
          title: "14.用纯 CSS 创建一个三角形的原理是什么？",
          answer: `采用的是相邻边框连接处的均分原理。
  将元素的宽高设为0，只设置
  border
  ，把任意三条边隐藏掉（颜色设为
...
`,
        ...
        {
          id: 16,
          title: "16.CSS 多列等高如何实现？",
          answer: `（1）利用padding-bottom|margin-bottom正负值相抵，不会影响页面布局的特点。设置父容器设置超出隐藏（overflow:
...
`,
        ...
        {
          id: 17,
          title: "17.经常遇到的浏览器的兼容性有哪些？原因，解决方法是什么，常用 hack 的技巧？",
          answer: `看GitHub`,
        },
        {
          id: 18,
          title: "18.li 与 li 之间有看不见的空白间隔是什么原因引起的？有什么解决办法？",
          answer: `浏览器会把inline元素间的空白字符（空格、换行、Tab等）渲染成一个空格。而为了美观。我们通常是一个<li>放在一行，
...
`,
        ...
        {
          id: 20,
          title: "20.什么是包含块，对于包含块的理解?",
          answer: `包含块（containing block）就是元素用来计算和定位的一个框。
...
`,
        ...
        {
          id: 21,
          title: "21.CSS 里的 visibility 属性有个 collapse 属性值是干嘛用的？在不同浏览器下以后什么区别？",
          answer: `（1）对于一般的元素，它的表现跟visibility：hidden;是一样的。元素是不可见的，但此时仍占用页面空间。
...
`,
        ...
        {
          id: 22,
          title: "22.width:auto 和 width:100%的区别",
          answer: `一般而言
...
`,
        ...
        {
          id: 23,
          title: "23.绝对定位元素与非绝对定位元素的百分比计算的区别",
          answer: `绝对定位元素的宽高百分比是相对于临近的position不为static的祖先元素的padding box来计算的。
...
`,
        ...
        {
          id: 24,
          title: "24.简单介绍使用图片 base64 编码的优点和缺点。",
          answer: `base64编码是一种图片处理格式，通过特定的算法将图片编码成一长串字符串，在页面上显示的时候，可以用该字符串来代替图片的
url属性。
...
`,
        ...
        {
          id: 25,
          title: "25.'display'、'position'和'float'的相互关系？",
          answer: `（1）首先我们判断display属性是否为none，如果为none，则position和float属性的值不影响元素最后的表现。
...
`,
        ...
        {
          id: 26,
          title: "26.margin 重叠问题的理解。",
          answer: `margin重叠指的是在垂直方向上，两个相邻元素的margin发生重叠的情况。
...
`,
        ...
        {
          id: 27,
          title: "27.对 BFC 规范（块级格式化上下文：block formatting context）的理解？",
          answer: `BFC指的是块级格式化上下文，一个元素形成了BFC之后，那么它内部元素产生的布局不会影响到外部元素，外部元素的布局也
...
`,
        },
        {
          id: 28,
          title: "28.IFC 是什么？",
          answer: `IFC指的是行级格式化上下文，它有这样的一些布局规则：
...
`,
        ...
        {
          id: 29,
          title: "29.请解释一下为什么需要清除浮动？清除浮动的方式",
          answer: `浮动元素可以左右移动，直到遇到另一个浮动元素或者遇到它外边缘的包含框。浮动框不属于文档流中的普通流，当元素浮动之后，
...
`,
        ...
        {
          id: 30,
          title: "30.使用 clear 属性清除浮动的原理？",
          answer: `使用clear属性清除浮动，其语法如下：
...
`,
        ...
        {
          id: 31,
          title: "31.zoom:1 的清除浮动原理?",
          answer: `清除浮动，触发hasLayout；
...
`,
        ...
        {
          id: 32,
          title: "32.移动端的布局用过媒体查询吗？",
          answer: `假设你现在正用一台显示设备来阅读这篇文章，同时你也想把它投影到屏幕上，或者打印出来，而显示设备、屏幕投影和打印等这些
...
`,
        ...
        {
          id: 33,
          title: "33.使用 CSS 预处理器吗？喜欢哪个？",
          answer: `SASS（SASS、LESS没有本质区别，只因为团队前端都是用的SASS）
`,
        },
        {
          id: 34,
          title: "34.CSS 优化、提高性能的方法有哪些？",
          answer: `加载性能：
...
`,
        ...
        {
          id: 35,
          title: "35.浏览器是怎样解析 CSS 选择器的？",
          answer: `样式系统从关键选择器开始匹配，然后左移查找规则选择器的祖先元素。只要选择器的子树一直在工作，样式系统就会持续左移，直
...
`,
        ...
        {
          id: 36,
          title: "36.在网页中应该使用奇数还是偶数的字体？为什么呢？",
          answer: `（1）偶数字号相对更容易和web设计的其他部分构成比例关系。比如：当我用了14px的正文字号，我可能会在一些地方用14
...
`,
        ...
        {
          id: 37,
          title: "37.margin 和 padding 分别适合什么场景使用？",
          answer: `margin是用来隔开元素与元素的间距；padding是用来隔开元素与内容的间隔。
...
`,
        ...
        {
          id: 38,
          title: "38.抽离样式模块怎么写，说出思路，有无实践经验？[阿里航旅的面试题]",
          answer: `我的理解是把常用的css样式单独做成css文件……通用的和业务相关的分离出来，通用的做成样式模块儿共享，业务相关的，放
进业务相关的库里面做成对应功能的模块儿。
`,
        },
        {
          id: 39,
          title: "39.简单说一下 css3 的 all 属性。",
          answer: `all属性实际上是所有CSS属性的缩写，表示，所有的CSS属性都怎样怎样，但是，不包括unicode-bidi和direction
...
`,
        ...
        {
          id: 40,
          title: "40.为什么不建议使用统配符初始化 css 样式。",
          answer: `采用*{padding:0;margin:0;}这样的写法好处是写起来很简单，但是是通配符，需要把所有的标签都遍历一遍，当网站较大时，
...
`,
        ...
        {
          id: 41,
          title: "41.absolute 的 containingblock（包含块）计算方式跟正常流有什么不同？",
          answer: `（1）内联元素也可以作为“包含块”所在的元素；
...
`,
        ...
        {
          id: 42,
          title: "42.对于 hasLayout 的理解？",
          answer: `hasLayout是IE特有的一个属性。很多的IE下的css bug都与其息息相关。在IE中，一个元素要么自己对自身的内容进
...
`,
        ...
        {
          id: 43,
          title: "43.元素竖向的百分比设定是相对于容器的高度吗？",
          answer: `如果是height的话，是相对于包含块的高度。
...
`,
        ...
        {
          id: 44,
          title: "44.全屏滚动的原理是什么？用到了 CSS 的哪些属性？（待深入实践）",
          answer: `原理：有点类似于轮播，整体的元素一直排列下去，假设有5个需要展示的全屏页面，那么高度是500%，只是展示100%，容器及容
...
`,
        ...
        {
          id: 45,
          title: "45.什么是响应式设计？响应式设计的基本原理是什么？如何兼容低版本的 IE？（待深入了解）",
          answer: `响应式网站设计是一个网站能够兼容多个终端，而不是为每一个终端做一个特定的版本。基本原理是通过媒体查询检测不同的设备屏
幕尺寸做处理。页面头部必须有meta声明的viewport。
`,
        },
        {
          id: 46,
          title: "46.视差滚动效果，如何给每页做不同的动画？（回到顶部，向下滑动要再次出现，和只出现一次分别怎么做？）",
          answer: `视差滚动是指多层背景以不同的速度移动，形成立体的运动效果，带来非常出色的视觉体验。
`,
        },
        {
          id: 47,
          title: "47.如何修改 chrome 记住密码后自动填充表单的黄色背景？",
          answer: `chrome表单自动填充后，input文本框的背景会变成黄色的，通过审查元素可以看到这是由于chrome会默认给自动填充的in
...
`,
        ...
        {
          id: 48,
          title: "48.怎么让 Chrome 支持小于 12px 的文字？",
          answer: `在谷歌下css设置字体大小为12px及以下时，显示都是一样大小，都是默认12px。
...
`,
        ...
        {
          id: 49,
          title: "49.让页面里的字体变清晰，变细用 CSS 怎么做？",
          answer: `webkit内核的私有属性：-webkit-font-smoothing，用于字体抗锯齿，使用后字体看起来会更清晰舒服。
...
`,
        ...
        {
          id: 50,
          title: "50.font-style 属性中 italic 和 oblique 的区别？",
          answer: `italic和oblique这两个关键字都表示“斜体”的意思。
...
`,
        ...
        {
          id: 51,
          title: "51.设备像素、css 像素、设备独立像素、dpr、ppi 之间的区别？",
          answer: `设备像素指的是物理像素，一般手机的分辨率指的就是设备像素，一个设备的设备像素是不可变的。
...
`,
        ...
        {
          id: 52,
          title: "52.layout viewport、visual viewport 和 ideal viewport 的区别？",
          answer: `移动端一共需要理解三个viewport的概念的理解。
...
`,
        ...
        {
          id: 53,
          title: "53.position:fixed;在 android 下无效怎么处理？",
          answer: `因为移动端浏览器默认的viewport叫做layout viewport。在移动端显示时，因为layout viewport的宽度大于移动端屏幕
...
`,
        ...
        {
          id: 54,
          title: "54.如果需要手动写动画，你认为最小时间间隔是多久，为什么？（阿里）",
          answer: `多数显示器默认频率是60Hz，即1秒刷新60次，所以理论上最小间隔为1/60*1000ms＝16.7ms
`,
        },
        {
          id: 55,
          title: "55.如何让去除 inline-block 元素间间距？",
          answer: `移除空格、使用margin负值、使用font-size:0、letter-spacing、word-spacing
`,
        },
        {
          id: 56,
          title: "56.overflow:scroll 时不能平滑滚动的问题怎么处理？",
          answer: `以下代码可解决这种卡顿的问题：-webkit-overflow-scrolling:touch;是因为这行代码启用了硬件加速特性，所以滑动很流
畅。
`,
        },
        {
          id: 57,
          title: "57.有一个高度自适应的 div，里面有两个 div，一个高度 100px，希望另一个填满剩下的高度。",
          answer: `（1）外层div使用position：relative；高度要求自适应的div使用position:absolute;top:100px;bottom:0;
left:0;right:0;
...
`,
        ...
        {
          id: 58,
          title: "58.png、jpg、gif 这些图片格式解释一下，分别什么时候用。有没有了解过 webp？",
          answer: `我了解到的一共有七种常见的图片的格式。
...
`,
        ...
        {
          id: 59,
          title: "59.浏览器如何判断是否支持 webp 格式图片",
          answer: `（1）宽高判断法。通过创建image对象，将其src属性设置为webp格式的图片，然后在onload事件中获取图片的宽高，如
...
`,
        ...
        {
          id: 60,
          title: "60.什么是 Cookie 隔离？（或者说：请求资源的时候不要让它带 cookie 怎么做）",
          answer: `网站向服务器请求的时候，会自动带上cookie这样增加表头信息量，使请求变慢。
...
`,
        ...
        {
          id: 61,
          title: "61.style 标签写在 body 后与 body 前有什么区别？",
          answer: `页面加载自上而下当然是先加载样式。写在body标签后由于浏览器以逐行方式对HTML文档进行解析，当解析到写在尾部的样式
...
`,
        ...
        {
          id: 62,
          title: "62.什么是 CSS 预处理器/后处理器？",
          answer: `CSS预处理器定义了一种新的语言，其基本思想是，用一种专门的编程语言，为CSS增加了一些编程的特性，将CSS作为目标生成
...
`,
        ...
        {
          id: 63,
          title: "63.阐述一下 CSSSprites",
          answer: `将一个页面涉及到的所有图片都包含到一张大图中去，然后利用CSS的background-image，background-repeat，background
...
`,
        ...
        {
          id: 65,
          title: "65.几种常见的 CSS 布局",
          answer: `https://juejin.cn/post/6844903710070407182#heading-12`,
        },
        {
          id: 66,
          title: "66.画一条 0.5px 的线",
          answer: `采用meta viewport的方式
...
`,
        ...
        {
          id: 67,
          title: "67.transition 和 animation 的区别",
          answer: `transition关注的是CSS property的变化，property值和时间的关系是一个三次贝塞尔曲线。
...
`,
        ...
        {
          id: 69,
          title: "69.为什么 height:100%会无效？",
          answer: `对于普通文档流中的元素，百分比高度值要想起作用，其父级必须有一个可以生效的高度值。
...
`,
        ...
        {
          id: 70,
          title: "70.min-width/max-width 和 min-height/max-height 属性间的覆盖规则？",
          answer: `（1）max-width会覆盖width，即使width是行类样式或者设置了!important。
...
`,
        },
        {
          id: 71,
          title: "71.内联盒模型基本概念",
          answer: `（1）内容区域（content area）。内容区域指一种围绕文字看不见的盒子，其大小仅受字符本身特性控制，本质上是一个字符盒子
...
`,
        },
        {
          id: 72,
          title: "72.什么是幽灵空白节点？",
          answer: `“幽灵空白节点”是内联盒模型中非常重要的一个概念，具体指的是：在HTML5文档声明中，内联元素的所有解析和渲染表现就如同
...
`,
        },
        {
          id: 73,
          title: "73.什么是替换元素？",
          answer: `通过修改某个属性值呈现的内容就可以被替换的元素就称为“替换元素”。因此，<img>、<object>、<video>、<iframe>或者表
...
`,
        },
        {
          id: 74,
          title: "74.替换元素的计算规则？",
          answer: `替换元素的尺寸从内而外分为3类：固有尺寸、HTML尺寸和CSS尺寸。
...
`,
        ...
        {
          id: 75,
          title: "75.content 与替换元素的关系？",
          answer: `content属性生成的对象称为“匿名替换元素”。
...
`,
        ...
        {
          id: 76,
          title: "76.margin:auto 的填充规则？",
          answer: `margin的'auto'可不是摆设，是具有强烈的计算意味的关键字，用来计算元素对应方向应该获得的剩余间距大小。但是触发mar
...
`,
        ...
        {
          id: 77,
          title: "77.margin 无效的情形",
          answer: `（1）display计算值inline的非替换元素的垂直margin是无效的。对于内联替换元素，垂直margin有效，并且没有ma
rgin合并的问题。
...
`,
        ...
        {
          id: 78,
          title: "78.border 的特殊性？",
          answer: `（1）border-width却不支持百分比。
...
`,
        ...
        {
          id: 79,
          title: "79.什么是基线和 x-height？",
          answer: `字母x的下边缘（线）就是我们的基线。
...
`,
        ...
        {
          id: 80,
          title: "80.line-height 的特殊性？",
          answer: `（1）对于非替换元素的纯内联元素，其可视高度完全由line-height决定。对于文本这样的纯内联元素，line-height就是高
...
`,
        ...
        {
          id: 81,
          title: "81.vertical-align 的特殊性？",
          answer: `（1）vertical-align的默认值是baseline，即基线对齐，而基线的定义是字母x的下边缘。因此，内联元素默认都是沿着字
...
`,
        ...
        {
          id: 82,
          title: "82.overflow 的特殊性？",
          answer: `（1）一个设置了overflow:hidden声明的元素，假设同时存在border属性和padding属性，则当子元素内容超出容器宽度
...
`,
        },
        {
          id: 83,
          title: "83.无依赖绝对定位是什么？",
          answer: `没有设置left/top/right/bottom属性值的绝对定位称为“无依赖绝对定位”。
...
`,
        ...
        {
          id: 84,
          title: "84.absolute 与 overflow 的关系？",
          answer: `（1）如果overflow不是定位元素，同时绝对定位元素和overflow容器之间也没有定位元素，则overflow无法对absolute
元素进行剪裁。
...
`,
        },
        {
          id: 85,
          title: "85.clip 裁剪是什么？",
          answer: `所谓“可访问性隐藏”，指的是虽然内容肉眼看不见，但是其他辅助设备却能够进行识别和访问的隐藏。
...
`,
        ...
        {
          id: 86,
          title: "86.relative 的特殊性？",
          answer: `（1）相对定位元素的left/top/right/bottom的百分比值是相对于包含块计算的，而不是自身。注意，虽然定位位移是相对自身，但是百分比值的计算值不是。
...
`,
        },
        {
          id: 87,
          title: "87.什么是层叠上下文？",
          answer: `层叠上下文，英文称作stacking context，是HTML中的一个三维的概念。如果一个元素含有层叠上下文，我们可以理解为这个元
素在z轴上就“高人一等”。
...
`,
        },
        {
          id: 88,
          title: "88.什么是层叠水平？",
          answer: `层叠水平，英文称作stacking level，决定了同一个层叠上下文中元素在z轴上的显示顺序。
...
`,
        },
        {
          id: 89,
          title: "89.元素的层叠顺序？",
          answer: `层叠顺序，英文称作 stacking order，表示元素发生层叠时有着特定的垂直显示顺序。`,
        },
        {
          id: 90,
          title: "90.层叠准则？",
          answer: `（1）谁大谁上：当具有明显的层叠水平标识的时候，如生效的z-index属性值，在同一个层叠上下文领域，层叠水平值大的那一个覆盖小的那一个。
...
`,
        ...
        {
          id: 91,
          title: "91.font-weight 的特殊性？",
          answer: `如果使用数值作为font-weight属性值，必须是100～900的整百数。因为这里的数值仅仅是外表长得像数值，实际上是一个具有特定含义的关键字，并且这里的数值关键字和字母关键字之间是有对应关系的。
`,
        },
        {
          id: 92,
          title: "92.text-indent 的特殊性？",
          answer: `（1）text-indent仅对第一行内联盒子内容有效。
...
`,
        ...
        {
          id: 93,
          title: "93.letter-spacing 与字符间距？",
          answer: `letter-spacing可以用来控制字符之间的间距，这里说的“字符”包括英文字母、汉字以及空格等。
...
`,
        ...
        {
          id: 94,
          title: "94.word-spacing 与单词间距？",
          answer: `letter-spacing作用于所有字符，但word-spacing仅作用于空格字符。换句话说，word-spacing的作用就是增加空格的间隙
宽度。
`,
        },
        {
          id: 95,
          title: "95.white-space 与换行和空格的控制？",
          answer: `white-space属性声明了如何处理元素内的空白字符，这类空白字符包括Space（空格）键、Enter（回车）键、Tab（制表符）
...
`,
        ...
        {
          id: 96,
          title: "96.隐藏元素的 background-image 到底加不加载？",
          answer: `-（1）元素的背景图片
...
p:after {
  ...
  background-color: #fff;
        ...
        },
        {
          id: 98,
          title: "98.常见的元素隐藏方式？",
          answer: `-（1）使用 display:none;隐藏元素，渲染树不会包含该渲染对象，因此该元素不会在页面中占据位置，也不会响应绑定的监听事件。
...
`,
        ...
        {
          id: 100,
          title: "100.css 两栏布局的实现？",
          answer: `两栏布局一般指的是页面中一共两栏，左边固定，右边自适应的布局，一共有四种实现的方式。
...
-（4）第四种还是利用绝对定位的方式，将父级元素设置为相对定位。左边元素宽度设置为 200px，右边元素设置为绝对定位，左边定位为 200px，其余方向定位为 0。`,
        ...
        {
          id: 101,
          title: "101.css 三栏布局的实现？",
          answer: `三栏布局一般指的是页面中一共有三栏，左右两栏宽度固定，中间自适应的布局，一共有五种实现方式。
...
`,
        ...
        {
          id: 102,
          title: "102.实现一个宽高自适应的正方形",
          answer: `/*1.第一种方式是利用vw来实现*/
.square {
  width: 10%;
  height: 10vw;
  background: tomato;
...
`,
        },
        {
          id: 103,
          title: "103.实现一个三角形",
          answer: `/*三角形的实现原理是利用了元素边框连接处的等分原理。*/
.triangle {
  width: 0;
  height: 0;
  border-width: 100px;
...
`,
        ...
        {
          id: 104,
          title: "104.一个自适应矩形，水平垂直居中，且宽高比为 2:1",
          answer: `/*实现原理参考自适应正方形和水平居中方式*/
.box {
  position: absolute;
  top: 0;
  right: 0;
...
`,
        ...
        {
          id: 105,
          title: "105.你知道 CSS 中不同属性设置为百分比%时对应的计算基准？",
          answer: `公式：当前元素某CSS属性值 = 基准 * 对应的百分比
